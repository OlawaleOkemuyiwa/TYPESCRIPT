...
function add(n1: number, n2: number) {
  //returning a number so the implicit return type when this func is called is number through inferance, if i explicitly set the return type here to e.g string. Then ts won't allow return n1 + n2 whose value is a number type
  return n1 + n2;
}
