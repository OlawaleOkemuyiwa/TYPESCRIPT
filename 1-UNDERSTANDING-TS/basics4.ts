...
function generateError(message: string, code: number): never {
  ...
  //this code returns nothing, it doesn't even return undefined as we're basically just throwing an error object from it. So the return type is never
